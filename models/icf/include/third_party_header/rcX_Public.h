...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rcX_Public.h 1845 2012-05-23 14:46:56Z stephans $
...
#define RCX_LIMK_STATUS_CHANGE_RES                    0x00002F8B
...
typedef __TLR_PACKED_PRE struct RCX_SET_FW_PARAMETER_CNF_DATA_Ttag
{
  TLR_PACKET_HEADER_T tHead;
} __TLR_PACKED_POST RCX_SET_FW_PARAMETER_CNF_DATA_T;

typedef __TLR_PACKED_PRE struct RCX_SET_FW_PARAMETER_CNF_Ttag
{
  TLR_PACKET_HEADER_T   tHead;
  RCX_SET_FW_PARAMETER_CNF_DATA_T tData;
} __TLR_PACKED_POST RCX_SET_FW_PARAMETER_CNF_T;

#define RCX_SET_FW_PARAMETER_CNF_SIZE sizeof(RCX_SET_FW_PARAMETER_CNF_T)

/******************************************************************************
 * RCX_LINK_STATUS_CHANGE_IND_T  //ARRC SPECIFIC
 ******************************************************************************/
...
#define RCX_LINK_STATUS_CHANGE_IND_SIZE sizeof(RCX_LINK_STATUS_CHANGE_IND_T)

/******************************************************************************
 * RCX_LINK_STATUS_CHANGE_RES_T  //ARRC SPECIFIC
 ******************************************************************************/
typedef __TLR_PACKED_PRE struct RCX_LINK_STATUS_CHANGE_RES_Ttag
{
	TLR_PACKET_HEADER_T tHead;
} __TLR_PACKED_POST RCX_LINK_STATUS_CHANGE_RES_T;
