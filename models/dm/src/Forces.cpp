...
void Forces::collect_forces_and_propagate() {
  ...
  if (Slosh_flag == 1) {
    ...
    double hn = h - (0.516 / 1.841) * (tanh((1.841 * h) / 2. * 0.516) -
                                       (1. / sinh((1.841 * h) / 0.516)));

    slosh_mass = (1.0 * (m_liq * ((2 * 0.516 * tanh(1.841 * h / 0.516)) /
                                  (1.841 * (1.841 * 1.841 - 1.) * h))));
...
void Forces::calculate_I_E() {
  ...
  I_E1(0, 0) = I_S2_E1(0, 0) +
               e1_mass * (rhoC_e1(1) * rhoC_e1(1) + rhoC_e1(2) * rhoC_e1(2));
  ...
  I_E1(1, 1) = I_S2_E1(1, 1) +
               e1_mass * (rhoC_e1(2) * rhoC_e1(2) + rhoC_e1(0) * rhoC_e1(0));
  ...
  I_E1(2, 2) = I_S2_E1(2, 2) +
               e1_mass * (rhoC_e1(0) * rhoC_e1(0) + rhoC_e1(1) * rhoC_e1(1));

  I_E2(0, 0) = I_S2_E2(0, 0) +
               e2_mass * (rhoC_e2(1) * rhoC_e2(1) + rhoC_e2(2) * rhoC_e2(2));
  ...
  I_E2(1, 1) = I_S2_E2(1, 1) +
               e2_mass * (rhoC_e2(2) * rhoC_e2(2) + rhoC_e2(0) * rhoC_e2(0));
  ...
  I_E2(2, 2) = I_S2_E2(2, 2) +
               e2_mass * (rhoC_e2(0) * rhoC_e2(0) + rhoC_e2(1) * rhoC_e2(1));

  I_E3(0, 0) = I_S2_E3(0, 0) +
               e3_mass * (rhoC_e3(1) * rhoC_e3(1) + rhoC_e3(2) * rhoC_e3(2));
  ...
  I_E3(1, 1) = I_S2_E3(1, 1) +
               e3_mass * (rhoC_e3(2) * rhoC_e3(2) + rhoC_e3(0) * rhoC_e3(0));
  ...
  I_E3(2, 2) = I_S2_E3(2, 2) +
               e3_mass * (rhoC_e3(0) * rhoC_e3(0) + rhoC_e3(1) * rhoC_e3(1));

  I_E4(0, 0) = I_S2_E4(0, 0) +
               e4_mass * (rhoC_e4(1) * rhoC_e4(1) + rhoC_e4(2) * rhoC_e4(2));
  ...
  I_E4(1, 1) = I_S2_E4(1, 1) +
               e4_mass * (rhoC_e4(2) * rhoC_e4(2) + rhoC_e4(0) * rhoC_e4(0));
  ...
  I_E4(2, 2) = I_S2_E4(2, 2) +
               e4_mass * (rhoC_e4(0) * rhoC_e4(0) + rhoC_e4(1) * rhoC_e4(1));
}
...
void Forces::funcv(int n, double *x, double *ff) {
  ...
  if (Slosh_flag == 1 && TWD_flag == 0) {
    f(0) = dot(p_b1_ga, gamma_b1_q1) + f_slosh(0) -
           (Q_G(0) + Q_TVC(0) + Q_Aero(0) + Q_G_slosh(0));
    f(1) = dot(p_b1_ga, gamma_b1_q2) + f_slosh(1) -
           (Q_G(1) + Q_TVC(1) + Q_Aero(1) + Q_G_slosh(1));
    f(2) = dot(p_b1_ga, gamma_b1_q3) + f_slosh(2) -
           (Q_G(2) + Q_TVC(2) + Q_Aero(2) + Q_G_slosh(2));
    f(3) = dot(p_b1_be, beta_b1_q4) + f_slosh(3) -
           (Q_G(3) + Q_TVC(3) + Q_Aero(3) + Q_G_slosh(3));
    f(4) = dot(p_b1_be, beta_b1_q5) + f_slosh(4) -
           (Q_G(4) + Q_TVC(4) + Q_Aero(4) + Q_G_slosh(4));
    f(5) = dot(p_b1_be, beta_b1_q6) + f_slosh(5) -
           (Q_G(5) + Q_TVC(5) + Q_Aero(5) + Q_G_slosh(5));
    f(6) = f_slosh(6) - Q_G_slosh(6);
    f(7) = f_slosh(7) - Q_G_slosh(7);
  } else if (TWD_flag == 1 && Slosh_flag == 0) {
    f(0) = dot(p_b1_ga, gamma_b1_q1) + f_S2_TWD(0) -
           (Q_G(0) + Q_TVC(0) + Q_Aero(0) + Q_G_S2_E(0));
    f(1) = dot(p_b1_ga, gamma_b1_q2) + f_S2_TWD(1) -
           (Q_G(1) + Q_TVC(1) + Q_Aero(1) + Q_G_S2_E(1));
    f(2) = dot(p_b1_ga, gamma_b1_q3) + f_S2_TWD(2) -
           (Q_G(2) + Q_TVC(2) + Q_Aero(2) + Q_G_S2_E(2));
    f(3) = dot(p_b1_be, beta_b1_q4) + f_S2_TWD(3) -
           (Q_G(3) + Q_TVC(3) + Q_Aero(3) + Q_G_S2_E(3));
    f(4) = dot(p_b1_be, beta_b1_q5) + f_S2_TWD(4) -
           (Q_G(4) + Q_TVC(4) + Q_Aero(4) + Q_G_S2_E(4));
    f(5) = dot(p_b1_be, beta_b1_q6) + f_S2_TWD(5) -
           (Q_G(5) + Q_TVC(5) + Q_Aero(5) + Q_G_S2_E(5));
    f(6) = f_S2_TWD(6) - Q_G_S2_E(6);
    f(7) = f_S2_TWD(7) - Q_G_S2_E(7);
    f(8) = f_S2_TWD(8) - Q_G_S2_E(8);
    f(9) = f_S2_TWD(9) - Q_G_S2_E(9);
  } else if (Slosh_flag == 1 && TWD_flag == 1) {
    f(0) = dot(p_b1_ga, gamma_b1_q1) + f_slosh(0) + f_S2_TWD(0) -
           (Q_G(0) + Q_TVC(0) + Q_Aero(0) + Q_G_slosh(0) + Q_G_S2_E(0));
    f(1) = dot(p_b1_ga, gamma_b1_q2) + f_slosh(1) + f_S2_TWD(1) -
           (Q_G(1) + Q_TVC(1) + Q_Aero(1) + Q_G_slosh(1) + Q_G_S2_E(1));
    f(2) = dot(p_b1_ga, gamma_b1_q3) + f_slosh(2) + f_S2_TWD(2) -
           (Q_G(2) + Q_TVC(2) + Q_Aero(2) + Q_G_slosh(2) + Q_G_S2_E(2));
    f(3) = dot(p_b1_be, beta_b1_q4) + f_slosh(3) + f_S2_TWD(3) -
           (Q_G(3) + Q_TVC(3) + Q_Aero(3) + Q_G_slosh(3) + Q_G_S2_E(3));
    f(4) = dot(p_b1_be, beta_b1_q5) + f_slosh(4) + f_S2_TWD(4) -
           (Q_G(4) + Q_TVC(4) + Q_Aero(4) + Q_G_slosh(4) + Q_G_S2_E(4));
    f(5) = dot(p_b1_be, beta_b1_q6) + f_slosh(5) + f_S2_TWD(5) -
           (Q_G(5) + Q_TVC(5) + Q_Aero(5) + Q_G_slosh(5) + Q_G_S2_E(5));
    f(6) = f_slosh(6) - Q_G_slosh(6);
    f(7) = f_slosh(7) - Q_G_slosh(7);
...
void Forces::slosh() {
  ...
  ddrhoC_slosh = cross(ddang_1, r_slosh) +
                 cross(dang_1, cross(dang_1, r_slosh));  // Eq.(5-64)

  /***********************************************/

  ddang_slosh =
      TSLOSHB2_SLOSHB1 * (TSLOSHB1_B * ddang_1 + domega_slosh1_B +
                          cross_matrix(dang_slosh1) * omega_slosh1_B) +
      domega_slosh2_slosh1 + cross_matrix(dang_slosh2) * omega_slosh2_slosh1;

  /************************************************/

  ddrP_slosh =
      ddrP_1 + trans(TBI) * ddrhoC_slosh +
      trans(TBSLOSH_I) *
          (cross(ddang_slosh, rhoC_slosh) +
           cross(dang_slosh2, cross(dang_slosh2, rhoC_slosh)));  // Eq.(5-12)
  ...
  f_slosh(3) =
      dot(p_slosh_ga, -trans(TBI) * cross_matrix(r_slosh) * beta_b1_q4) +
      dot(p_slosh_ga,
          -trans(TBSLOSH_I) * cross_matrix(rhoC_slosh) * beta_slosh_q4);
  f_slosh(4) =
      dot(p_slosh_ga, -trans(TBI) * cross_matrix(r_slosh) * beta_b1_q5) +
      dot(p_slosh_ga,
          -trans(TBSLOSH_I) * cross_matrix(rhoC_slosh) * beta_slosh_q5);
  f_slosh(5) =
      dot(p_slosh_ga, -trans(TBI) * cross_matrix(r_slosh) * beta_b1_q6) +
      dot(p_slosh_ga,
          -trans(TBSLOSH_I) * cross_matrix(rhoC_slosh) * beta_slosh_q6);
  f_slosh(6) = dot(p_slosh_ga, -trans(TBSLOSH_I) * cross_matrix(rhoC_slosh) *
                                   beta_slosh_q7) -
               dot(QD7, beta_slosh_q7);
  f_slosh(7) = dot(p_slosh_ga, -trans(TBSLOSH_I) * cross_matrix(rhoC_slosh) *
                                   beta_slosh_q8) -
               dot(QD8, beta_slosh_q8);
}

void Forces::S2_TWD() {
  arma::vec3 p_e1_ga, p_e2_ga, p_e3_ga, p_e4_ga, p_e1_be, p_e2_be, p_e3_be,
      p_e4_be, domega_e1_B, domega_e2_B, domega_e3_B, domega_e4_B;
  arma::mat33 TBI = grab_TBI();
  ...
  /*******************************************************************************************************/
  ddrP_e1 = ddrP_1 + trans(TBI) * (cross(ddang_1, e1_d) +
                                   cross(dang_1, cross(dang_1, e1_d)));
  ddrP_e2 = ddrP_1 + trans(TBI) * (cross(ddang_1, e2_d) +
                                   cross(dang_1, cross(dang_1, e2_d)));
  ddrP_e3 = ddrP_1 + trans(TBI) * (cross(ddang_1, e3_d) +
                                   cross(dang_1, cross(dang_1, e3_d)));
  ddrP_e4 = ddrP_1 + trans(TBI) * (cross(ddang_1, e4_d) +
                                   cross(dang_1, cross(dang_1, e4_d)));
  /*******************************************************************************************************/
  domega_e1 =
      (TE1_B * ddang_1 - cross_matrix(dang_e1) * omega_e1_B + domega_e1_B);
  domega_e2 =
      (TE2_B * ddang_1 - cross_matrix(dang_e2) * omega_e2_B + domega_e2_B);
  domega_e3 =
      (TE3_B * ddang_1 - cross_matrix(dang_e3) * omega_e3_B + domega_e3_B);
  domega_e4 =
      (TE4_B * ddang_1 - cross_matrix(dang_e4) * omega_e4_B + domega_e4_B);
  /*******************************************************************************************************/
  ddrhoC_e1 =
      cross(domega_e1, rhoC_e1) + cross(dang_e1, cross(dang_e1, rhoC_e1));
  ddrhoC_e2 =
      cross(domega_e2, rhoC_e2) + cross(dang_e2, cross(dang_e2, rhoC_e2));
  ddrhoC_e3 =
      cross(domega_e3, rhoC_e3) + cross(dang_e3, cross(dang_e3, rhoC_e3));
  ddrhoC_e4 =
      cross(domega_e4, rhoC_e4) + cross(dang_e4, cross(dang_e4, rhoC_e4));
  /*******************************************************************************************************/
  ...
  /*******************************************************************************************************/
  f_S2_TWD(0) = dot(p_e1_ga, gamma_b1_q1) + dot(p_e2_ga, gamma_b1_q1) +
                dot(p_e3_ga, gamma_b1_q1) + dot(p_e4_ga, gamma_b1_q1);
  f_S2_TWD(1) = dot(p_e1_ga, gamma_b1_q2) + dot(p_e2_ga, gamma_b1_q2) +
                dot(p_e3_ga, gamma_b1_q2) + dot(p_e4_ga, gamma_b1_q2);
  f_S2_TWD(2) = dot(p_e1_ga, gamma_b1_q3) + dot(p_e2_ga, gamma_b1_q3) +
                dot(p_e3_ga, gamma_b1_q3) + dot(p_e4_ga, gamma_b1_q3);
  f_S2_TWD(3) = dot(p_e1_ga, -trans(TBI) * cross_matrix(e1_d) * beta_b1_q4) +
                dot(p_e1_be, beta_S2_e1_q4) +
                dot(p_e2_ga, -trans(TBI) * cross_matrix(e2_d) * beta_b1_q4) +
                dot(p_e2_be, beta_S2_e2_q4) +
                dot(p_e3_ga, -trans(TBI) * cross_matrix(e3_d) * beta_b1_q4) +
                dot(p_e3_be, beta_S2_e3_q4) +
                dot(p_e4_ga, -trans(TBI) * cross_matrix(e4_d) * beta_b1_q4) +
                dot(p_e4_be, beta_S2_e4_q4);
  f_S2_TWD(4) = dot(p_e1_ga, -trans(TBI) * cross_matrix(e1_d) * beta_b1_q5) +
                dot(p_e1_be, beta_S2_e1_q5) +
                dot(p_e2_ga, -trans(TBI) * cross_matrix(e2_d) * beta_b1_q5) +
                dot(p_e2_be, beta_S2_e2_q5) +
                dot(p_e3_ga, -trans(TBI) * cross_matrix(e3_d) * beta_b1_q5) +
                dot(p_e3_be, beta_S2_e3_q5) +
                dot(p_e4_ga, -trans(TBI) * cross_matrix(e4_d) * beta_b1_q5) +
                dot(p_e4_be, beta_S2_e4_q5);
  f_S2_TWD(5) = dot(p_e1_ga, -trans(TBI) * cross_matrix(e1_d) * beta_b1_q6) +
                dot(p_e1_be, beta_S2_e1_q6) +
                dot(p_e2_ga, -trans(TBI) * cross_matrix(e2_d) * beta_b1_q6) +
                dot(p_e2_be, beta_S2_e2_q6) +
                dot(p_e3_ga, -trans(TBI) * cross_matrix(e3_d) * beta_b1_q6) +
                dot(p_e3_be, beta_S2_e3_q6) +
                dot(p_e4_ga, -trans(TBI) * cross_matrix(e4_d) * beta_b1_q6) +
                dot(p_e4_be, beta_S2_e4_q6);
