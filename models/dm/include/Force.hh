...
class Forces : public Dynamics {
 ...
 private:
  ...
  /* Generating Outputs */
  arma::vec
      FAPB; /* *o (N)      Aerodynamic and propulsion forces in body axes */
  double
      _FAPB[3]; /* *o (N)      Aerodynamic and propulsion forces in body axes */

  arma::vec FAP;  /* *o (N)      Aerodynamic force in body axes */
  double _FAP[3]; /* *o (N)      Aerodynamic force in body axes */

  arma::vec
      FMB; /* *o (N*m)    Aerodynamic and propulsion moment in body axes */
  double
      _FMB[3]; /* *o (N*m)    Aerodynamic and propulsion moment in body axes */

  arma::vec
      FMAB; /* *o (N*m)    Aerodynamic and propulsion moment in body axes */
  double
      _FMAB[3]; /* *o (N*m)    Aerodynamic and propulsion moment in body axes */
