...
class GPS_constellation {
 ...
 private:
  ...
  int allocateChannel(channel_t *chan, ephem_t *eph, ionoutc_t ionoutc,
                      time_util::GPS_TIME grx, arma::vec3 XYZ, double elvMask);
  int checkSatVisibility(ephem_t eph, time_util::GPS_TIME g, arma::vec3 xyz,
                         double elvMask, arma::vec2 &azel);
  void computeRange(range_t *rho, ephem_t eph, ionoutc_t *ionoutc,
                    time_util::GPS_TIME g, arma::vec3 XYZ);
  int replaceExpDesignator(char *str, int len);
  void satpos(ephem_t eph, time_util::GPS_TIME g, arma::vec3 &pos,
              arma::vec3 &vel, arma::vec2 &clk);
  ...
  double ionosphericDelay(const ionoutc_t *ionoutc, time_util::GPS_TIME g,
