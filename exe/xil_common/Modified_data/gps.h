...
extern "C" void record_gps() {
    ...
    drg->add_variable("rkt.dynamics._ABIB[1]");
    drg->add_variable("rkt.dynamics._ABIB[2]");
    drg->add_variable("rkt.dynamics._FMAB[0]");
    drg->add_variable("rkt.dynamics._FMAB[1]");
    drg->add_variable("rkt.dynamics._FMAB[2]");
    drg->add_variable("rkt.dynamics._FAPB[0]");
    drg->add_variable("rkt.dynamics._FAPB[1]");
    drg->add_variable("rkt.dynamics._FAPB[2]");
    ...
    drg->add_variable("rkt.dynamics._Q_Aero[0]");
    drg->add_variable("rkt.dynamics._Q_Aero[1]");
    drg->add_variable("rkt.dynamics._Q_Aero[2]");
    drg->add_variable("rkt.dynamics._Q_Aero[3]");
    drg->add_variable("rkt.dynamics._Q_Aero[4]");
    drg->add_variable("rkt.dynamics._Q_Aero[5]");
